...
$(document).ready(function(){
        ...
        $('ul.nav li, ul.submenu').on('click',function() {
	...
	<body class="no-skin">
		<div id="navbar" class="navbar navbar-default          ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left" style="font-family: aldine;font-style: italic;">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="{{url('trabajadores/create')}}">
									<i class="menu-icon fa fa-caret-right"></i>
									Agregar
								</a>
...
<![endif]-->
		...
		<script src="{{asset('assets/js/locale/es.js')}}"></script>
