...
<h3 align="center">Confirmar reserva</h3>
<div class="row">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-9">
            {!!Form::text('fecha',$reserva->fecha,['class'=>'col-xs-10 col-sm-8', 'placeholder'=>'Ingrese el nombre','required','id'=>'txtfecha','id'=>'fecha']) !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
            {!!Form::textarea('detalle',$reserva->detalle,['rows'=>'5', 'class'=>'col-xs-10 col-sm-8', 'placeholder'=>'Detalles','required']) !!}
            </div>
        </div>
         <div class="form-group">
